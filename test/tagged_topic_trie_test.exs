defmodule TaggedTopicTrieTest do
  ...
  test "find clients with a wildcard topic" do
    t =
      TaggedTopicTrie.new()
      |> TaggedTopicTrie.insert("level1/level2/*", "client1")
      |> TaggedTopicTrie.insert("level1/*/level3", "client2")
      |> TaggedTopicTrie.insert("level1/*/level3", "client2")

    assert TaggedTopicTrie.find_wildcard_topic(t, "level1/level2") == []
  ...
  test "remove client with wildcard topic" do
    ...
    assert TaggedTopicTrie.find_wildcard_topic(t1, "level1/level2/level3") == ["client3"]
    ...
    assert TaggedTopicTrie.find_wildcard_topic(t2, "level1/level2/level3") == []
  end
